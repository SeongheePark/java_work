...
public class ServerTest {
	...
	// 서버 측에서 키보드 데이터를 받기 위해 입력 스트림이 필요하다
	// 키보드에 대한 입력 데이터를 담당
	...
	private void initData() {
		try {
			...
			// 클라이언트 접속 대기
			socket = serverSocket.accept(); // 대기하고있음 --> 클라이언트가 들어오면 소켓반환
