...
public class MapMainTest {
	...
	public static void main(String[] args) {
		...
		Hashtable<String, String> map2 = new Hashtable<>(); // v -null값 허용 안함!
		...
		for (int i = 0; i < map1.size(); i++) {
			System.out.println(map1.get(i)); // null
		}

		// map은 원래 순서가 없지만 응용을 하면 key 값으로 for문 정도는 활용할 수 있다
		...
		// map계열의 값을 꺼낼 때는 key값으로 접근 --> value 값이 반환
